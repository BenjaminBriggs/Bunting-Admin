...
import type { CohortTargetingRule, RuleCondition } from '@/types/rules';
...
export function CohortRuleBuilder({
	...
	const hasIncompleteConditions = rule.conditions.some(
							...
							{hasIncompleteConditions && (
								<Alert severity="warning">
									<Typography variant="body2">
										This rule has incomplete conditions. Please specify values
										for all conditions.
									</Typography>
								</Alert>
							)}
										...
										>
											...
											>
												...
												<Box sx={{ display: 'flex', gap: 1 }}>
													<IconButton
														size="small"
														onClick={() => handleEditCondition(conditionIndex)}
													>
														<Edit />
													</IconButton>
			...
			<ConditionBuilderModal
				...
				existingCondition={
					editingConditionIndex !== null
						? rule.conditions[editingConditionIndex]
						: undefined
				}
				contextType="cohort"
			/>
