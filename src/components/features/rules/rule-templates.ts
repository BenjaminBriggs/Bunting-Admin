...
export const conditionTemplates: ConditionTemplate[] = [
  {
    ...
    operators: ['equals', 'does_not_equals', 'greater_than', 'less_than', 'greater_than_or_equal', 'less_than_or_equal', 'between'],
    valueType: 'text',
  ...
  },
  {
    type: 'locale',
    label: 'Locale',
    description: 'Target users based on their locale. "in"/"not_in" use prefix matching (e.g. "en" matches "en-US").',
  ...
  },
  {
    ...
    description: 'Target users based on custom attributes defined in your app. The attribute name is passed to the SDK\'s custom attribute resolver.',
    operators: ['custom'],
    valueType: 'text',
