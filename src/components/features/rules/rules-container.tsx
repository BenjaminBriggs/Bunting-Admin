		...
		<Card>
			<CardContent sx={{ p: 3 }}>
				...
				<Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
					Define when this flag should return different values based on user
					attributes and conditions. Rules are evaluated in order, and the first
				...
				<Stack spacing={3}>
					...
					{rules.length === 0 ? (
						<Alert severity="info" icon={<Info />}>
							No targeting rules defined. This flag will return its default
							value for all users.
							<br />
							Add rules to conditionally return different values based on user
							attributes.
						</Alert>
					) : (
						<Stack spacing={2}>
							<Alert severity="info">
								Rules are evaluated from top to bottom. The first rule with
								matching conditions determines the returned value.
							</Alert>
