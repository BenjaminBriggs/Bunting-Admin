...
import { BarChart, CloudUpload, Flag, Settings } from '@mui/icons-material';
import {
	AppBar,
	Box,
	Button,
				...
				<Toolbar sx={{ justifyContent: 'space-between' }}>
					...
					<Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
						...
						<Button
							...
							color="success"
							size="small"
							sx={{ display: 'none' }} // Will be made visible when changes detected
						>
							Publish
							<Chip
								label="3"
						...
						<FormControl size="small" sx={{ minWidth: 180 }}>
							...
							<Select value="" label="Select Application" disabled>
