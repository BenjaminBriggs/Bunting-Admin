...
export default function SetupPage() {
  ...
  const handleNameChange = (name: string) => {
    ...
    setSetupData((prev) => ({ ...prev, appName: name, appIdentifier: identifier }));
  };
        ...
        return (
          <Stack spacing={3}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setSetupData((prev) => ({ ...prev, appIdentifier: e.target.value }))
              }
              fullWidth
              required
            ...
            <Alert severity="info">
              Published configs are stored in the instance's configured bucket and served via{" "}
              <code>CDN_BASE_URL</code>. The SDK fetch URL is derived from the identifier above —
              no per-app storage setup needed.
            </Alert>
          </Stack>
        );
